...
import { initialiseVersion, futurePatchSelected } from "./config/version-config.js";
...
const startSimulation = () => {
    ...
    const simulationData = {
        ...
        light_of_the_martyr_uptime: document.getElementById("light-of-the-martyr-option").value,
