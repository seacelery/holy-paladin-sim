...
def update_priority_breakdown(priority_breakdown, caster, current_time, priority_list_number, spell_name, player_active_auras, resources, heal=None, is_crit=None, target_active_auras=None, remaining_cooldowns=None, aura_counts=None):
    if caster.last_iteration:
        priority_breakdown[current_time] = {"priority_list_number": priority_list_number, "spell_name": spell_name, "player_active_auras": player_active_auras,
                                            "resources": resources, "heal": heal, "is_crit": is_crit, "target_active_auras": target_active_auras, "remaining_cooldowns": remaining_cooldowns, "total_target_aura_counts": aura_counts}