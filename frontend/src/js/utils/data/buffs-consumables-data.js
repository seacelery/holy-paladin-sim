const flasks = {
    ...
    "Phial of Elemental Chaos":  {effect: "Infuse yourself with the power of the elements, granting you a random elemental boon that changes every 60 sec Each boon increases a secondary stat by 652 and grants a bonus effect", image: "https://render.worldofwarcraft.com/eu/icons/56/inv_10_alchemy_bottle_shape2_orange.jpg"},
...
const potions = {
    "Aerated Mana Potion": {effect: "Restores 27600 mana", image: "https://render.worldofwarcraft.com/eu/icons/56/inv_10_alchemy_bottle_shape2_black.jpg"},
    "Elemental Potion of Ultimate Power": {effect: "Increases your Intellect by 886 for 30 seconds", image: "https://render.worldofwarcraft.com/eu/icons/56/inv_10_alchemy_bottle_shape2_black.jpg"},
}
